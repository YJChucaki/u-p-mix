...
# for i in 1637:1650
    ...
    ndiv= 16
    ndiv_p= 24
    elements,nodes,nodes_p = import_fem_quad_plate_with_hole("./msh/plate_with_hole_"*string(ndiv)*".msh","./msh/plate_with_hole_"*string(i)*".msh")
    # elements,nodes,nodes_p =import_fem_tri3_plate_with_hole("./msh/plate_with_hole_"*string(ndiv)*".msh","./msh/plate_with_hole_"*string(i)*".msh")
