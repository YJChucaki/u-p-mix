...
set𝓖!(elements["Γᵍ₁"],:SegGI5,:∂1)
set𝓖!(elements["Γᵍ₂"],:SegGI5,:∂1)
set𝓖!(elements["Γ̃ᵍ₁"],:SegGI5,:∂1,:∂x,:∂y,:∂z)
set𝓖!(elements["Γ̃ᵍ₂"],:SegGI5,:∂1,:∂x,:∂y,:∂z)
set𝓖!(elements["Γᵗ₁"],:SegGI5,:∂1)
set𝓖!(elements["Γᵗ₂"],:SegGI5,:∂1)
set𝓖!(elements["Γᵗ₃"],:SegGI5,:∂1)
...
@timeit to "shape functions Γᵗ" set𝝭!(elements["Γᵗ₂"])
@timeit to "shape functions Γᵗ" set𝝭!(elements["Γᵗ₃"])
@timeit to "shape functions Γᵍ" set∇𝝭!(elements["Γ̃ᵍ₁"])
@timeit to "shape functions Γᵍ" set∇𝝭!(elements["Γ̃ᵍ₂"])
...
@timeit to "assembly in Γᵗ" ops[2](elements["Γᵗ₂"],f)
@timeit to "assembly in Γᵗ" ops[2](elements["Γᵗ₃"],f)
@timeit to "assembly in Γᵍ" ops[3](elements["Γ̃ᵍ₁"],k,f)
@timeit to "assembly in Γᵍ" ops[3](elements["Γ̃ᵍ₂"],k,f)
